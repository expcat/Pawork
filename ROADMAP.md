...
| [R2](plan/R2-dependency-governance.md) | 依赖治理 | rand/parking_lot/base64 本地化;notify 8、windows 0.61、portable-pty 0.9、ts-rs 12、reqwest 0.13、toml 1.1、rusqlite 0.40、sha2 0.11 升级;lock 多版本去重断言;rmcp 3.x 专项 | 各 crate Cargo.toml + 少量调用点 | R1 | 🔵(波 A ✅ 2026-08-19,L1–L3 本地化收口:rand/parking_lot/base64 退出直接依赖,getrandom 0.4 统一 OS 熵,auth 本地 base64url 含对拍固定向量;波 B ✅ 2026-08-20,U1–U8+U10 九项落地:notify 8.2/windows 0.61.3/portable-pty 0.9/ts-rs 12(7 文件形状变化用户拍板接受)/reqwest 0.13.4(rustls 栈切换已登记)/toml 1.1.4/rusqlite 0.40.2/sha2 0.11/directories 6(macOS 快照 golden×2),lock 836→830;波 C rmcp 专项与波 D 收口待开) |
