...
| [R2](plan/R2-dependency-governance.md) | 依赖治理 | rand/parking_lot/base64 本地化;notify 8、windows 0.61、portable-pty 0.9、ts-rs 12、reqwest 0.13、toml 1.1、rusqlite 0.40、sha2 0.11 升级;lock 多版本去重断言;rmcp 3.x 专项 | 各 crate Cargo.toml + 少量调用点 | R1 | 🔵(波 A ✅ 2026-08-19,L1–L3 本地化收口:rand/parking_lot/base64 退出直接依赖,getrandom 0.4 统一 OS 熵,auth 本地 base64url 含对拍固定向量;波 B–D 待开) |
