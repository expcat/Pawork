...
//!
//! 本波只迁入模块与单测，不接到 [`crate::GuiBroadcastSink`] 热路径。

use std::collections::{BTreeMap, VecDeque};
use std::sync::Mutex;
use std::time::{Duration, Instant};

use pawork_domain::{ArtifactId, MessageId, RunId, ToolCallId};
use pawork_protocol::{AppEvent, AppEventEnvelope};
...
mod tests {
    use super::*;
    use pawork_domain::{CommandId, CoreInstanceId, EventId, Timestamp};
    use pawork_protocol::{EventSource, EventStream, GlobalSequence, API_VERSION};
