...
impl SettingsAuthAction {
    ...
    pub(crate) fn key(&self) -> &'static str {
        match self {
            ...
            Self::OpenOauth => "open-oauth",
            Self::CopyOauthUrl => "copy-oauth-url",
            Self::CopyOauthCode => "copy-oauth-code",
    ...
    pub(crate) fn label(&self) -> &'static str {
        match self {
            ...
            Self::OpenOauth => t("settings.providers.open_oauth"),
            Self::CopyOauthUrl => t("settings.providers.copy_oauth_url"),
            Self::CopyOauthCode => t("settings.providers.copy_oauth_code"),
