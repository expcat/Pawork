...
| 阶段状态 | R0 🟢(波 0/A/B/C 全部收口,2026-08-18;改判 3+1 项见 ADR-038 落实改判记录);R1 🟢(波 A–E 全部收口,2026-08-19);R2 🟢(波 A/B/C/D 全部收口,2026-08-20);R3 🟢(波 A/B/C/D 全部收口 + 整阶段审计修复,2026-08-20~21);R4 🔵(波 A 收口,2026-08-21;波 B 未开始);R5–R9 ⚪ |
...
| **下一波次** | R4 波 B(CommandLedger 幂等持久化 + K-02 审批等待前落盘语义;storage 新迁移 + app(idempotency/approval);串行单一 owner;无 ADR 闸门) |
| 阻塞 | 无 |
