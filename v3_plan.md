...
| 字段 | 值 |
| --- | --- |
| 当前阶段 | R7 🔵 波 A 已收口([plan/R7-sandbox-isolation.md](plan/R7-sandbox-isolation.md):macOS profile 写白名单正式化 + golden 先行六面落钉,2026-08-23);下一波 R7 波 B |
...
| **下一波次** | R7 波 B(PTY 创建入闸:app gui_host PTY 装配 + exec pty ∥ shell 手写 tokenizer:policy shell;并行 ×2;TerminalCreate 响应/TerminalOutput 帧 golden 先行) |
| 阻塞 | 无 |
