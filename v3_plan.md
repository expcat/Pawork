...
| **下一波次** | R8 波 C(TimelineEntryView/ApprovalCard/DiffView/InputArea 拆分 + Timeline list() 虚拟化替换 + 长标题 truncate;写入集 apps/desktop/src/ui/;串行——Timeline 是核心面) |
| 阻塞 | 无 |
