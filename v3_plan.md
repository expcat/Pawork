...
| 字段 | 值 |
| --- | --- |
| 当前阶段 | R5([plan/R5-provider-neutrality.md](plan/R5-provider-neutrality.md))🔵 进行中(波 A 已收口,2026-08-22) |
| 阶段状态 | R0 🟢(波 0/A/B/C 全部收口,2026-08-18;改判 3+1 项见 ADR-038 落实改判记录);R1 🟢(波 A–E 全部收口,2026-08-19);R2 🟢(波 A/B/C/D 全部收口,2026-08-20);R3 🟢(波 A/B/C/D 全部收口 + 整阶段审计修复,2026-08-20~21);R4 🟢(波 A/B/C/D 全部收口 + 整阶段审计修复,2026-08-21~22);R5 🔵(波 A 收口,2026-08-22);R6–R9 ⚪ |
...
| **下一波次** | R5 波 B(credential locator 合一 + keychain 词汇迁移 + mcp-auth 域隔离收编;串行,Secret 面单一 owner;无 ADR 闸门) |
| 阻塞 | 无 |
