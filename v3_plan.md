...
| 阶段状态 | R0 🟢(波 0/A/B/C 全部收口,2026-08-18;改判 3+1 项见 ADR-038 落实改判记录);R1 🟢(波 A–E 全部收口,2026-08-19);R2 🟢(波 A/B/C/D 全部收口,2026-08-20);R3 🟢(波 A/B/C/D 全部收口 + 整阶段审计修复,2026-08-20~21);R4 🔵(波 A/B 收口,2026-08-21;波 C 未开始);R5–R9 ⚪ |
...
| **下一波次** | R4 波 C(ACP actor 化 ∥ 降级事件契约 DegradeEvent 定义 + host 接点;cli channels/acp/ ∥ protocol/domain(事件定义)+ app(接点);并行 ×2,DegradeEvent 契约面主代理先定形状;无 ADR 闸门) |
| 阻塞 | 无 |
