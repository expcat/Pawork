...
| 字段 | 值 |
| --- | --- |
| 当前阶段 | R7 🔵 波 0 已收口([plan/R7-sandbox-isolation.md](plan/R7-sandbox-isolation.md):[ADR-041](docs/adr/ADR-041-sandbox-trust-model.md) Accepted,2026-08-23);下一波 R7 波 A |
| 阶段状态 | R0 🟢(波 0/A/B/C 全部收口,2026-08-18;改判 3+1 项见 ADR-038 落实改判记录);R1 🟢(波 A–E 全部收口,2026-08-19);R2 🟢(波 A/B/C/D 全部收口,2026-08-20);R3 🟢(波 A/B/C/D 全部收口 + 整阶段审计修复,2026-08-20~21);R4 🟢(波 A/B/C/D 全部收口 + 整阶段审计修复,2026-08-21~22);R5 🟢(波 A/B/C 全部收口 + 整阶段审计修复,2026-08-22;真实 Anthropic 冒烟 fail-closed 登记 ROADMAP §4);R6 🟢(波 0/A/B/C 全部收口,2026-08-23；真实 fork/compact 冒烟登记 ROADMAP §4 人工验收);R7 🔵(波 0 ✅ ADR-041 Accepted,2026-08-23);R8–R9 ⚪ |
...
| **下一波次** | R7 波 A(macOS profile 写白名单正式化 + 读洞/标签如实化 + Linux 语义对齐复核 + Windows 标签复核;exec sandbox/ 串行,安全内核单一 owner) |
| 阻塞 | 无 |
