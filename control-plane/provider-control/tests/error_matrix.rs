...
//!
//! 依赖 `account-control-v1`（classifier / health）；关 feature 时跳过。
#![cfg(feature = "account-control-v1")]

use std::sync::atomic::{AtomicU64, Ordering};
use std::sync::Arc;

use pawork_domain::{AccountId, CredentialId, ModelId, ProviderId, Timestamp};
...
impl pawork_provider_control::account::Clock for MutableClock {
