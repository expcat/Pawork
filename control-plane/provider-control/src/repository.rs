...
use pawork_domain::{AccountId, CredentialId, ProviderId, TenantId, Timestamp};
use async_trait::async_trait;
use pawork_api::CredentialKind as ProviderCredentialKind;
use thiserror::Error;
