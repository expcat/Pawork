...
V1 已有大量同构资产（详见 [provider-control-plane](../../../docs/features/provider-control-plane.md)、[usage-quota](../../../docs/features/usage-quota.md)、[context](../../../docs/features/context.md)），V2 在 S11 激活（见 [../../ROADMAP.md](../../ROADMAP.md) §2 阶段表与 [../design.md](../design.md) §2 包激活映射）：
