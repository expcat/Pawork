...
fn severity_label(severity: pawork_domain::ReviewSeverity) -> &'static str {
    match severity {
        pawork_domain::ReviewSeverity::Info => "info",
        pawork_domain::ReviewSeverity::Minor => "minor",
        pawork_domain::ReviewSeverity::Major => "major",
        pawork_domain::ReviewSeverity::Critical => "critical",
    }
}
