...
//! 给调用方（由 session-store 封装为 `pawork_domain::AgentEvent::Goal` 持久化）。
...
use pawork_domain::{CriterionKind, GoalEvent, GoalId, GoalStatus, SuccessCriterionSnapshot};

use super::error::GoalError;
use super::snapshot::GoalSnapshot;
use super::state::{apply, recompute_progress, GoalState};
...
mod tests {
    use super::*;
    use crate::goal::replay;
    use pawork_domain::GoalStatus;
