...
- 当前（V2 遗留）布局为 39 成员按功能域分目录，见 [docs/design.md](docs/design.md) §2；V3 目标布局为 21 成员（19 库 + 2 应用），由 [plan/R1-package-consolidation.md](plan/R1-package-consolidation.md) 与 ADR-039 定稿执行，收口后回写 design.md §2 与本节。
