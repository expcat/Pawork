...
static COMMANDS: &[RegistryEntry] = &[
    ...
    RegistryEntry {
        wire_name: "auth_account_set_selection_mode",
        gui: GuiChannelAccess {
            available: true,
            required_capability: None,
        },
...
static QUERIES: &[RegistryEntry] = &[
    ...
    RegistryEntry {
        wire_name: "skill_record_preview",
        gui: GuiChannelAccess {
            available: true,
            required_capability: None,
        },
...
pub fn command_wire_name(command: &AppCommand) -> &'static str {
    match command {
        ...
        AppCommand::TasksCancel { .. } => "tasks_cancel",
        AppCommand::PlanReject { .. } => "plan_reject",
        AppCommand::PlanApprove { .. } => "plan_approve",
        AppCommand::PlanSubmit { .. } => "plan_submit",
        AppCommand::GoalStart { .. } => "goal_start",
        AppCommand::GoalPause { .. } => "goal_pause",
        AppCommand::GoalResume { .. } => "goal_resume",
        AppCommand::GoalSteer { .. } => "goal_steer",
        AppCommand::GoalFinish { .. } => "goal_finish",
        AppCommand::SkillRecordSave { .. } => "skill_record_save",
        AppCommand::PlanSave { .. } => "plan_save",
        ...
        AppCommand::AuthAccountSetSelectionMode { .. } => "auth_account_set_selection_mode",
        AppCommand::AuthAccountRename { .. } => "auth_account_rename",
