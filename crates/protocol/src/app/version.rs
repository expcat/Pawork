...
/// Cross-process task cancellation through the owning GUI Host.
pub const V1_23: ApiVersion = ApiVersion {
    major: 1,
    minor: 23,
};

pub const V1_24: ApiVersion = ApiVersion {
    major: 1,
    minor: 24,
};
...
pub const PROTOCOL_CRATE_COMPATIBILITY: &[ProtocolCrateCompatibility] = &[
    ProtocolCrateCompatibility {
        api: V1_24,
        crate_version: "0.1.0",
        note: "Plan, goal and product attachments",
    },
    ProtocolCrateCompatibility {
        api: V1_23,
        crate_version: "0.1.0",
        note: "GUI Host task cancellation",
    },
    ProtocolCrateCompatibility {
        api: V1_22,
        crate_version: "0.1.0",
