...
pub const API_VERSION: ApiVersion = V1_21;
...
pub const SUPPORTED_API_VERSIONS: &[ApiVersion] = &[
    ...
    V1_15, V1_16, V1_17, V1_18, V1_19, V1_20, V1_21,
];
...
mod tests {
    ...
    fn version_helpers_and_supported_table_are_consistent() {
        assert_eq!(ApiVersion::new(1, 21), API_VERSION);
        ...
        assert_eq!(
            ...
            &[
                ...
                V1_13, V1_14, V1_15, V1_16, V1_17, V1_18, V1_19, V1_20, V1_21
            ]
        );
    ...
    fn handshake_types_do_not_embed_crate_semver() {
        ...
        assert_eq!(version, serde_json::json!({"major": 1, "minor": 21}));
    }
