...
pub const API_VERSION: ApiVersion = V1_5;
...
pub const SUPPORTED_API_VERSIONS: &[ApiVersion] = &[V1_0, V1_1, V1_2, V1_3, V1_4, V1_5];
...
mod tests {
    ...
    fn version_helpers_and_supported_table_are_consistent() {
        assert_eq!(ApiVersion::new(1, 5), API_VERSION);
    ...
    fn handshake_types_do_not_embed_crate_semver() {
        ...
        assert_eq!(version, serde_json::json!({"major": 1, "minor": 5}));
    }
