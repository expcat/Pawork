...
use agent_domain::{CancellationToken, MemoryEvent, MemoryId, ModelId, WorkspaceId};
use provider_api::{EmbeddingProvider, EmbeddingRequest};
...
mod tests {
    ...
    impl EmbeddingProvider for FixedEmbedder {
        fn id(&self) -> agent_domain::ProviderId {
            agent_domain::ProviderId::new("fixed-embedder")
        }
    ...
    async fn record_and_retrieve_roundtrip() {
        ...
        assert_eq!(
            ...
            agent_domain::MemoryPrivacy::WorkspaceLocal
        );
