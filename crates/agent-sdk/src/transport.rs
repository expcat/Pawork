...
use headless_json::MAX_FRAME_BYTES;
...
pub struct PaworkOptions {
    ...
    pub capabilities: Vec<headless_json::SdkCapability>,
}
...
impl Default for PaworkOptions {
    fn default() -> Self {
        ...
        Self {
            ...
            client_name: "agent-sdk".into(),
            client_version: crate::SDK_VERSION.into(),
            capabilities: vec![
                headless_json::SdkCapability::Sessions,
                headless_json::SdkCapability::Runs,
                headless_json::SdkCapability::Streaming,
                headless_json::SdkCapability::CompatImport,
                headless_json::SdkCapability::CompatHistory,
            ],
        }
    }
}
