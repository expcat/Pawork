...
use agent_domain::AgentProfileV2;
use mcp_client::config::McpServerConfig;
...
pub enum CompatPayload {
    ...
    Instructions {
        instruction_kind: resource_loader::ResourceInstructionKind,
        body: String,
    ...
    Skill {
        manifest: resource_loader::SkillManifest,
        body: String,
    },
    ...
    UserHook { hook: user_hooks::HookConfig },
    /// 权限规则 / 全局审批模式。
    PermissionRule {
        /// None 表示全局审批模式规则。
        tool: Option<String>,
