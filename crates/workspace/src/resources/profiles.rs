...
fn parse_profile(
    ...
    let file: ProfileFileRaw = super::io::parse_toml_resource(
        &content,
...
fn validate_tool_rules(
    ...
    for (label, list) in [
        ...
        for tool in list {
            if !super::io::is_valid_identifier(tool, true) {
                return Err(ResourceIssue::error(
...
fn validate_references(
    ...
    for reference in references {
        if !super::io::is_valid_identifier(&reference.id, true) {
            return Err(ResourceIssue::error(
...
fn validate_name(name: &str) -> Result<(), String> {
    if !super::io::is_valid_identifier(name, true) {
        return Err(format!(
...
mod tests {
    ...
    fn skill_ref_resolves_against_loaded_skill_with_version_req() {
        let skill = super::super::skills::LoadedSkill {
            manifest: super::super::skills::SkillManifest {
                id: "rust".into(),
