...
//!
//! ```no_run
//! # async fn example() -> Result<(), pawork_client::headless::SdkError> {
//! use pawork_client::headless::{PaworkClient, PaworkOptions};
...
/// 便捷入口：`pawork_client::headless::spawn_pawork(options)`。
pub use client::spawn_pawork;

/// 实验面：API 可能在不发 major 的情况下调整；使用前请核对版本说明。
pub mod experimental {
    pub use crate::headless::client::CompatOutcome;
}
