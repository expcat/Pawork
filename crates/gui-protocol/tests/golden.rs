...
use gui_protocol::{
    ...
    ResumeDisposition, ServerFrame, Snapshot, SnapshotSection, SnapshotSectionKind,
};
...
fn client_handshake_frame() -> ClientFrame {
    ClientFrame::Handshake(HandshakeRequest {
        ...
        supported_api_versions: vec![core_api::ApiVersion { major: 1, minor: 0 }],
...
fn client_command_frame() -> ClientFrame {
    ClientFrame::Command(AppCommandEnvelope {
        ...
        identity: ActorIdentity::LocalUser {
            actor_id: agent_domain::ActorId::from("actor-1"),
            display_name: None,
        },
        ...
        command: AppCommand::SessionCreate {
            workspace_id: agent_domain::WorkspaceId::from("workspace-1"),
            title: None,
        },
    })
}
