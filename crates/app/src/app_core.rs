//! `AppCore` 装配与领域门面（CLN-6：从 crate 根拆出）。
...
use crate::channels;
use crate::checkpoint::{CheckpointSummary, RollbackOutcome};
use crate::control::{self, UsageOverview};
use crate::data_dir::{
    artifact_store_path_for, consume_data_dir_outcome, default_data_dir_outcome,
...
pub struct AppCore {
    ...
    pub(crate) session_estimator: Arc<dyn pawork_storage::session::TokenEstimator>,
    pub(crate) adapter_protocol: AdapterProtocol,
