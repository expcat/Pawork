...
//! `plan_service::PlanState` 的状态机折叠，避免重复实现 P16-2 review 状态机。

use std::collections::{BTreeMap, BTreeSet};

use agent_domain::{AgentId, PlanId, TenantId};
use orchestration::{TaskId, TaskState};
use plan_service::PlanState;

use crate::event::{BoardTask, Recipients, TeamEvent, TeamEventEnvelope};
use crate::ids::{MailboxMessageId, MemberRole, TeamId};
...
pub struct MailboxEntry {
    ...
    /// [`crate::peer::PeerPolicy`] 展开并随事件持久化。
