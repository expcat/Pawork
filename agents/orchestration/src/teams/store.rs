...
//! 后，事件才允许被折叠进聚合、推进序列并镜像到上游（[`crate::teams::service::TeamService`]
...
use crate::teams::error::TeamStoreError;
use crate::teams::event::TeamEventEnvelope;
...
///    重建 [`crate::teams::state::TeamAggregate`]。
...
mod tests {
    ...
    use crate::teams::event::TeamEventSequence;
    use crate::teams::ids::TeamId;
