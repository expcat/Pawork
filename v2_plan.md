...
| 字段 | 值 |
| --- | --- |
| 当前阶段 | S10（[plan/S10-serve-clients.md](plan/S10-serve-clients.md)）10a 波 A–B 已完成；下一波为 S10 10b |
...
| **下一波次** | **S10 10b（并行 ×4）**：gui-server 多客户端、Desktop Replay/Fork/Terminal、channels(`acp`)、exec(pty)+session(lifecycle) |
