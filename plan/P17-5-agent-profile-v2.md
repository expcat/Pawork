...
> Phase 17 · Ecosystem & Host Compatibility · 状态：🟡未开始 · 交付成熟度：Designed · 依赖：P8-5、P8-3、P9-6、P4-9、P17-1、P3-6、P16-4、P16-7、P11-1、P6-9
...
4. **memory / max turns / effort** —— 目的：memory（接入 [P16-7](P16-7-long-term-memory.md) 长期记忆）、max turns（接入 [P3-6](P3-6-budget-control.md) 预算控制）、effort / reasoning（接入 [P6-9](P6-9-provider-options.md) provider options）。
