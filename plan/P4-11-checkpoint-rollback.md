...
> Phase 4 · 核心工具与权限 · 状态：🟢已完成 · 依赖：P1-6、P1-7（「导出 patch / 固化为 commit」步骤另依赖 P7-1 git-service；Phase 7 完成前先交付基于 Blob Store 的 checkpoint / 回滚）
...
- [x] 可回滚单次 tool call 与整个 run
- [x] 不默认 `git reset --hard`
- [x] 冲突可检测
