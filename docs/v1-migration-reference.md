...
>
> 关联文档：[../ROADMAP.md](../ROADMAP.md)（V2 任务索引）· [design.md](design.md)（V2 设计文档）· [../../Pawork_v1/ROADMAP.md](../../Pawork_v1/ROADMAP.md)（V1 路线图）· [../../Pawork_v1/REVIEW.md](../../Pawork_v1/REVIEW.md)（V1 各 Phase 评审记录）· [../../Pawork_v1/docs/architecture/workspace-layout.md](../../Pawork_v1/docs/architecture/workspace-layout.md)（V1 crate 注册表）· [../../Pawork_v1/AGENTS.md](../../Pawork_v1/AGENTS.md)（V1 工作约定，已归档）。
...
**问题二：组件齐全、主干未通电（最严重）。** [../../Pawork_v1/REVIEW.md](../../Pawork_v1/REVIEW.md) §0.2 自 P2 起持续记录该模式，至今未根治。全 workspace 依赖扫描（2026-08-14）确认零生产消费者的 crate：
...
- 关键佐证文档：[../../Pawork_v1/REVIEW.md](../../Pawork_v1/REVIEW.md)（「组件齐全、主干未通电」系统性发现及各 Phase V 项）、[../../Pawork_v1/plan/README.md](../../Pawork_v1/plan/README.md)（V1 Phase 15–18 延期落点登记）、[../../Pawork_v1/docs/review/](../../Pawork_v1/docs/review/)（各 Phase 行号级证据）。
