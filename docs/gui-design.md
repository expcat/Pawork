...
| Markdown | 段落、1–6 级标题（同字号加粗）、无序/有序列表、引用、fenced code、粗体、斜体、行内代码；链接显示标签与目标文本，尚无点击动作。代码保留原始换行，流式未闭合标记保留内容；不是完整 CommonMark / 表格渲染器。 |
