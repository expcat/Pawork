...
状态：**用户已于 2026-09-08 回复「确认实施」；方案已接受，G1 已实现，定向自动检查与代理真窗口检查通过，等待用户人工视觉验收**。实施前基线为 `main` / `697f5fc3`；接受决策见 [ADR-059](../spec/settings.md#adr-059ui-6b-命名账号与持久选择2026-09-08)，验证状态以 [ROADMAP](roadmap-ui-2026-09-09.md) 为准。下文源码缺口表保留实施前核查语境。
