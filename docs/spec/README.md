...
| [../ROADMAP.md](../ROADMAP.md) | 当前待办、2026-09-21 新一轮功能复测与未闭合验收；历史记录从 Git 追溯 |
...
| Desktop 优化线 | OPT-D、OPT-1～OPT-4 | **已关闭**（2026-09-07）。全文与验收证据见 review/roadmap-opt-2026-09-05.md（Git `f8df04b2:docs/review/roadmap-opt-2026-09-05.md`）。OPT-D 已签字；OPT-1～OPT-4 均已实现并验收。 |
| Desktop 模块重设计线 | UI-1～UI-6 | 2026-09-07 真窗口走查立项，每个任务重设计一个模块的 UI 与交互；均已实现，全文与验收证据移存 review/roadmap-ui-2026-09-09.md（Git `f8df04b2:docs/review/roadmap-ui-2026-09-09.md`）。 |
| GUI 用户体验收口线 | UX-01～UX-09 | 已实现并有原批次定向检查记录；部分真窗口与用户验收未完成，详见 历史记录（Git `f8df04b2:docs/review/roadmap-ux-2026-09-10.md`）；剩余验收由当前路线图承接，迁存不等于任务归档。 |
| GUI 第二阶段 | GUI2-01～GUI2-07 | 已实现并有原批次自动检查与代理真窗口记录；用户验收未闭合。仅剩余工作进入 [ROADMAP.md](../ROADMAP.md)，原批次证据从 Git `f8df04b2:docs/ROADMAP.md` 追溯。 |
