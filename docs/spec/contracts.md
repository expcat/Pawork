...
| CON-GUI-01 | GUI Connection Protocol | API `1.5`；支持 `1.0/1.1/1.2/1.3/1.4/1.5`；`ClientFrame`/`ServerFrame`；上限 1 MiB | app GUI host ↔ client/Desktop | [protocol](../../crates/protocol/src)；[schemas/gui-protocol](../../schemas/gui-protocol)；protocol fixtures/golden |
| CON-REGISTRY-01 | Command/Capability Registry | 24 `AppCommand`、13 `AppQuery`；GUI/headless/ACP 可用性同源 | protocol registry → app/cli/client | [registry](../../crates/protocol/src/app/registry.rs) |
