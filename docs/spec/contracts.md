...
| CON-STORAGE-01 | Session SQLite | `CURRENT_SCHEMA_VERSION = 12`；v11 增 `command_ledger`，v12 原生 branch lineage | app/storage → resume/fork/compact/import | [migration](../../crates/storage/src/session/migration.rs)；[升级 fixtures](../../crates/storage/src/session/fixtures) |
...
- SQLite 迁移按版本追加。v1–v11 不回写；v12 的重建/回填失败必须整批 fail-closed。
