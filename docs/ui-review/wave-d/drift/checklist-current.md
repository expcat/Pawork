# State A checklist-current - sidebar-320-drift

Generated 2026-08-26T23:46:29Z; manifest: run-manifest.json.

Structural assertions (AX tree + frame probe):

- [PASS] initial/root-1440x1024 - root w=1440.0 h=1024.0 (contract 1440x1024 +/-0.5)
- [FAIL] initial/rail-width - task-rail w=320.0 (contract 288 +/-4.32)
...
- [PASS] initial/workspace-span - workspace x=320.0..1000.0 expected 320.0..1000.0
...
- [FAIL] final/rail-width - task-rail w=320.0 (contract 288 +/-4.32)
...
- [PASS] final/workspace-span - workspace x=320.0..1000.0 expected 320.0..1000.0
...
- gate exit=1; zones passed 0/9 (threshold=0.99); global SSIM=0.339632 (auxiliary)
- [FAIL] zone taskrail ssim=0.389266
- [FAIL] zone header-left ssim=0.223531
- [FAIL] zone header-right ssim=0.294702
- [FAIL] zone timeline ssim=0.306935
- [FAIL] zone composer-left ssim=0.250409
- [FAIL] zone composer-right ssim=0.281251
- [FAIL] zone inspector-body ssim=0.408333
- [FAIL] zone inspector-right ssim=0.376173
- [FAIL] zone statusbar ssim=0.400226
